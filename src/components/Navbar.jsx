...
import logo from "../assets/images/logo/TnakRean.jpg";

export default function Navbar() {
  return (
    <div>
      <div>
        <nav class="bg-white dark:bg-gray-800 border-b border-mygray mx-auto px-24">
          <div class="max-w-7xl ">
            <div class="flex items-center justify-between h-16">
              <div class=" flex items-center">
                ...
                <div class="hidden md:block">
                  <div class="ml-10 flex items-baseline space-x-4  font-bold text-xl">
                    <a
                      class="text-mygreen hover:text-gray-800 dark:hover:text-white px-3 py-2 rounded-md "
                      href="/#"
                    >
                      Register
                    </a>
