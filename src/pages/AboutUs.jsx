...
import { AiFillGitlab, AiFillGoogleCircle,AiFillLinkedin } from "react-icons/ai";
...
export default function AboutUs() {
  return (
    <div>
      ...
      ABOUT US
      <p className="w-20 mt-1 myhr"></p></div>
      ...
      <div class="col-span-3 ml-6 font-medium lg:text-lg text-center flex">
        ...
        <p className="mt-12">TnakRean is website that created by Korea Software HRD Center in 2022.
        ...
        <div class="container px-6 py-10 mx-auto ">
          ...
          <div class="container mt-14 mx-1">
            <div class="flex flex-row flex-wrap text-center m-auto">
              ...
              {/* second card sinuon*/}
              <div class="basis-1/3 bg-pink-300 items-center p-8 transition-colors duration-200 transform cursor-pointer rounded-xl ">
                <div class="">
                  <img
                ...
                <p class="mt-2 text-myorange text-lg">"People respect the money not the person."</p>
              ...
              <div class="basis-1/3 bg-pink-900 items-center p-8 transition-colors duration-200 transform cursor-pointer rounded-xl ">
                ...
                <p class="mt-2 text-myorange text-lg">"He alone, who owns the youth, gains the future."</p>
      ...
      <div class="flex text-center text-gray-500 mb-10 mt-10 justify-center">
        Copyright <p className="px-1 pt-1"><BiCopyright/></p> 2022 TnakRean. All right reserved.
      </div>
      <RegisterV2/>
    </div>
  );
